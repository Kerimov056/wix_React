        ...
        <>
            <div className='caursel'>
                <div className='caursel_in'>
                    ...
                    <h5>Company name</h5>
                    <div>
                        <p className={change === 1} style={{opacity: change === 1 ? 1 : 0.6}} onClick={() => slide(1)}></p>
                        <p className={change === 2} style={{opacity: change === 2 ? 1 : 0.6}} onClick={() => slide(2)}></p>
                        <p className={change === 3} style={{opacity: change === 3 ? 1 : 0.6}} onClick={() => slide(3)}></p>
                    </div>
                </div>
            </div>
        </>
